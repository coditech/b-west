...
import '../styles/IranImage.css';
/**
 * Component source:  https://github.com/IRIdeveloper/react-iron-image
* */
    ...
    render() {
        return (
            <div className="iron-image-container">
                <div className="iron-image-loaded" ref={imageLoadedElem => this.ironImageHd = imageLoadedElem}>
                    <img src="" alt=""/>
                </div>
                <div className="iron-image-preload" style={{backgroundImage: `url('${this.props.srcPreload}')`}}/>
            </div>
        )
    }
