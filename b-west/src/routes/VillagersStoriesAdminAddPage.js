...
class VillagersStoriesAdminAddPage extends React.Component {
    ...
    render() {
        return (
            <div>
                <div className="row">
                    <h2 className="col-sm-6 col-sm-push-3">Villagers Stories Page Section</h2>
...
export {VillagersStoriesAdminAddPage};