...
class FeaturedProductsAdminEditPage extends React.Component {

    constructor(props, context) {
        super(props, context);

        const id = props.match.params.id;
        const featuredProducts = props.featuredProducts.find(item => {
            return item.id === id
        });
        const {name, description, slug, price, status, imageAlt} = featuredProducts;
        let state = {
            ...props,
            featuredProducts,
            id,
        ...
        if (featuredProducts.imageSrc) {
            state.imageSrc = featuredProducts.imageSrc;
        }
...
export {FeaturedProductsAdminEditPage};